namespace Ordering.Application.Orders.Commands.UpdateOrder
{
    internal class UpdateOrderHandler(IApplicationDbContext dbContext) : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
    {
        ...
        private void UpdateOrderWithNewValues(Order order, OrderDto orderDto)
        {
            ...
            var updatedPayments = Payment.Of(orderDto.Payment.CardName, orderDto.Payment.CardNumber, orderDto.Payment.Expiration, orderDto.Payment.Cvv, orderDto.Payment.PaymentMethod);
